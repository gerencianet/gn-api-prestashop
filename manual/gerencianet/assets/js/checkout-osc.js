jQuery(document).ready(function($){
    ...
    function payCardCharge() {
        ...
        card_brand = $('input[name=gn_card_brand]:checked', '#card-form').val()
    ...
    jQuery('#gn-billet-payment-option').click(function(e){
        ...
        $('#paymentMethodCardRadio').prop('checked', false);
        $('#card-radio-button span').removeClass('checked');
        $('#billet-radio-button span').addClass('checked');
    ...
    jQuery('#gn-card-payment-option').click(function(e){
        ...
        $('#card-radio-button span').addClass('checked');
        $('#billet-radio-button span').removeClass('checked');
