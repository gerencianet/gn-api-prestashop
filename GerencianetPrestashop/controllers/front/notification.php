...
class GerencianetPrestashopNotificationModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        $gerencianet = $this->module;
        $gerencianet->validateNotification(Tools::getValue('notification'));
    }
}
