...
class Request
{
    ...
    public function send($method, $route, $requestOptions)
    {
        ...
        try {
            ...
            $this->request = $this->client->createRequest($method, $this->config['baseUri'] . $route, $requestOptions);
            ...
            throw new GerencianetException(json_decode($se->getResponse()->getBody(), true), $se->getResponse()->getStatusCode());
        }
    }
